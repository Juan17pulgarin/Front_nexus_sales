    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <aside className="w-64 bg-white dark:bg-slate-900 border-r flex flex-col h-full shrink-0">
        ...
        <nav className="flex-1 px-3 space-y-1 text-sm font-semibold">
          ...
          {/* NUEVAS OPCIONES */}
          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-500 hover:bg-slate-100" href="/sales">
            <span className="material-symbols-outlined">receipt_long</span>
            Sales
          </a>

          <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-500 hover:bg-slate-100" href="/reports">
            <span className="material-symbols-outlined">monitoring</span>
            Reports
          </a>

          <a className="mt-auto flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-500 hover:bg-slate-100" href="/settings">
        ...
        <div className="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input className="w-full mt-1 p-2 bg-slate-50 border rounded-lg"
            ...
            <div>
              ...
              <input required className="w-full mt-1 p-2 bg-slate-50 border rounded-lg"
            ...
            <div className="col-span-2">
              ...
              <input required type="email" className="w-full mt-1 p-2 bg-slate-50 border rounded-lg"
            ...
            <div className="col-span-2 flex gap-3 pt-6">
              ...
              <button type="submit"
                className="flex-1 p-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 shadow-lg">
